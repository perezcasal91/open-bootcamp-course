package com.perezcasal.laptopdeploy.entities;
...
public class LaptopEntity {
    ...
    @Schema(name = "brand", description = "Brand",
            type = "String", example = "HP or MAC")
    private String brand;
    @Column(name = "storage")
    @Schema(name = "storage", description = "Storage",
            type = "String", example = "HDD or SDD")
    ...
    public String toString() {
        return String
                .format("Laptop[id=%d, brand='%s', storage='%s'" +
                                ", price='%s', releaseDate='%s', wifi='%s']",
