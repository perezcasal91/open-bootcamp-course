...
public class InterfaceSegregationMain {
    public static void main(String[] args) {
        ...
        printStatistics(users.getUsersDB());
    }

    private static void printStatistics(UsersDB usersDB) {
        if (usersDB instanceof MemoryUsersDB){
            System.out.println("Total of insertions: "
                    + ((MemoryUsersDB) usersDB).getInsertionsCount());
            System.out.println("Total of deletions: "
                    +((MemoryUsersDB) usersDB).getDeletionsCount());
        }
    }
...
interface UsersDBStatistic {
    int getInsertionsCount();
    int getDeletionsCount();
}
class FileUsersDB implements UsersDB {
...
class MemoryUsersDB implements UsersDB, UsersDBStatistic {
